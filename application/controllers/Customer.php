<?php
 class Customer extends CI_Controller{
     ...
     public function dashboard()
     {
        ...
        $vehicle  =$this->db->query("SELECT V.* FROM vehicle V")->result();
        ...
        $min_vehid = $this->db->query("SELECT MIN(vehicle_id) AS min_veh_id FROM vehicle")->row()->min_veh_id;
        $data['first_vehicle'] = $this->db->query("SELECT * FROM vehicle WHERE vehicle_id =".$min_vehid)->result();
		$this->load->view("customer/dashboard",$data);

     }
     function select_vehicle($vehicle_id){
